...
if ($type) {
    $sql .= " AND (cours_pdf LIKE '%$type%' OR td_pdf LIKE '%$type%' OR tp_pdf LIKE '%$type%')";
}
...
<div class="sidebar">
    <ul>
        ...
        <li><a href="afficher_programme.php">Courses</a></li>
...
<div class="main-content">
    ...
    <form method="GET">
        ...
        <input type="number" name="semestre" value="<?= $semestre; ?>" placeholder="Semestre"><br>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <a href='modifier_matiere.php?id=" . $row['id'] . "' class='btn'>Modifier</a>
    ...
    <a href="adj.html" class="add-btn">Ajouter une matière</a>
